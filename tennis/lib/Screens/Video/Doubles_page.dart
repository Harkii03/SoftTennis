...
class DoublesPage extends StatefulWidget {
  const DoublesPage({Key? key}) : super(key: key);
  @override
  _DoublesPageState createState() => _DoublesPageState();
}

class _DoublesPageState extends State<DoublesPage> {
  // YoutubeAPIのキー
  static String key = "";
